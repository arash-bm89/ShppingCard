...
namespace ShoppingCard.Api.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserResponse>> Create(UserCreateRequest userRequest)
        {
            ...
            if (nameExist)
            {
                return BadRequest($"Name {userRequest.Name} is already in use");
            }
            ...
            if (emailExist)
            {
                return BadRequest($"Email {userRequest.Email} is already in use");
            }
