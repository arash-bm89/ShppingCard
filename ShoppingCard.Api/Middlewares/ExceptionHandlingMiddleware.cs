...
public class ExceptionHandlingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (Exception e)
        {
            ...
            if (context.Response.HasStarted) throw new Exception("operation already started.");
    ...
    {
        var internalServerErrorMessageBytes =
            Encoding.UTF8.GetBytes(JsonConvert.SerializeObject("InternalServerError has been occurred"));
